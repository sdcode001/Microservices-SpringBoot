...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to fetch version number of Loans."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to fetch version of java in system environment of Loans microservice."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Fetch Loans microservice contact info REST API",
            description = "REST API to fetch contact info of Loans microservice."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @GetMapping(value = "/loans-contact-info")
    public ResponseEntity<LoansContactInfoDto> getAccountContactInfo(){
        System.out.println("loans-contact-info is called...");
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(this.loansContactInfo);
    }
